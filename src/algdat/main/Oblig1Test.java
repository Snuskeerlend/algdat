///// Oppdatert 15. september 2013 ///////////////

package algdat.main;
import algdat.hjelpelasser.Oblig1;
...
public class Oblig1Test
{
  ...
  public static int oppgave8()
  {
    ...
    try
    {
      Oblig1.tredjeMinst(tabell);  // kaller metoden
    }
    catch (Exception e)
    {
      unntak = true;
      ...
      {
        System.out.println("Opgave 8: Feil unntak!");
        antallFeil++;
      }
    }
    ...
    {
      System.out.println
        ("Opgave 8: Det skal kastes unntak for tabeller med for få verdier!");
      antallFeil++;
    }
    ...
    while (flere1)
    {
      int[] c = Oblig1.tredjeMinst(a1);

      if (a1[c[0]] != 1 || a1[c[1]] != 2 || a1[c[2]] != 3)
      {
        System.out.println("Oppgave 8: Feil når a = " + Arrays.toString(a1));
        antallFeil++;
      }
    ...
    int[] b = randPerm(10);
    int[] d = Oblig1.tredjeMinst(b);


    if (b[d[0]] != 1 || b[d[1]] != 2 || b[d[2]] != 3)
    {
      System.out.println("Oppgave 8: Feil når a = " + Arrays.toString(b));
      antallFeil++;
    }

    int[] x = {6,3,9,1,10,5,2,8,4,7};
    int[] y = x.clone();
    Oblig1.tredjeMinst(x);

    if (!Arrays.equals(x,y))
    {
      System.out.println
        ("Oppgave 8: Metoden gjør endringer i parametertabellen!");
      antallFeil++;
    }
    ...
    while (flere2)
    {
      ...
      {
        System.out.println("Oppgave 8: Feil når a = " + Arrays.toString(a));
        antallFeil++;
        break;
      }
  ...
  public static int oppgave9()
  {
    ...
    catch (Exception e)
    {
      ...
      if (!(e instanceof IllegalArgumentException))
      {
        System.out.println("Opgave 9: Feil unntak for k < 1!");
        antallFeil++;
      }
    }
    ...
    {
      System.out.println
        ("Oppgave 9: Metoden gjør endringer i koden!");
      antallFeil++;
    }
    ...
    {
      System.out.println
        ("Oppgave 9: Metoden er altfor ineffektiv!");
      antallFeil++;
    }
  ...
  public static int oppgave10() throws IOException
  {
    ...
    {
      System.out.println
        ("Oppgave 10: For ineffektiv! Må forbedres! Har du treg nettforbindelse?");
      antallFeil++;
    }
    return antallFeil;
  }
